...
To build Igloo Lawn locally using Gradle:

```bash
# Clone the repository
git clone https://github.com/gaurav9372/Igloo-Lawn.git
cd Igloo-Lawn
...
Igloo Lawn builds upon the incredible work of the open-source community:

- **Original Lawnchair Project**: Thanks to the [Lawnchair Team](https://lawnchair.app) and all open-source contributors.
- **Android Open Source Project**: Built on top of Android's [Launcher3](https://android.googlesource.com/platform/packages/apps/Launcher3/).
- **License**: Distributed under the [GNU General Public License v3.0](LICENSE.txt).
