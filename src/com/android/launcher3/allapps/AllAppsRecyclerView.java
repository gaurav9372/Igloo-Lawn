...
public class AllAppsRecyclerView extends FastScrollRecyclerView {
                ...
                if (mPullGestureActive && mPullStartY >= 0) {
                    ...
                    if (dy > threshold) {
                        ...
                        post(() -> {
                            ...
                            if (editText != null) {
                                if (editText instanceof SearchUiManager.SearchInputView) {
                                    ((SearchUiManager.SearchInputView) editText).setDirectFocus(true);
                                }
    ...
    public boolean isPullToSearchActive() {
        return mPullGestureActive;
    }
